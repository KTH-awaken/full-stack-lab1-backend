...
//        return new AccountVm(account.getEmail(),account.getFirstName(), account.getLastName() ,account.getAge(),account.getUserType(),account.getPassword(),account.getReceivedMessages(),account.getSentMessages());
//    }
    //Patient
//    public static PatientVm convertFromPatientToPatientVM(Patient patient){
//        PatientVm patientVm = new PatientVm(patient.getId(), patient.getmCondition(),accountMapper.toAccountVM(patient.getAccount()));
//        return patientVm;
//    }
